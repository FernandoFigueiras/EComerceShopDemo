<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterConfirmation.aspx.cs" Inherits="TimeZone.RegisterConfirmation" %>
      ...
      <form runat="server">
           <div id="divModalNoSuccess" runat="server" class ="modalDialog" visible="false">
               <div>
                   ...
                   <br />
			     <asp:Button runat="server"	ID="btnClose" Text="Close" data-toggle="modal"  OnClientClick="return" OnClick="CloseModal"/>
               </div>
           </div>
      </form>

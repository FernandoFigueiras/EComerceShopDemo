<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteUser.aspx.cs" Inherits="TimeZone.DeleteUser" %>
                ...
                <div class="section-top-border">
                    <div class="row">
                        <div class="col-lg-8 col-md-8" style="text-align: center">
                            <h3 class="mb-30">Tem a certeza que pretende apagar o utilizador?</h3>
                            <form runat="server">
                                ...
                                <div id="divModal" runat="server" class="modalDialog" visible="false">
                                    <div>
                                        <h2>Atencao</h2>
                                        <p>Nao sera possivel recuperar dados</p>
                                        <br />
                                        <div style="text-align: center">
                                            <asp:Button runat="server" ID="btnOk" Text="Ok" data-toggle="modal" OnClientClick="return" OnClick="btnOk_Click"/>
                                ...
                                <div class="mt-10">
                                    <asp:Label runat="server" ID="FN"></asp:Label>
                                   </div>
                                <div class="mt-10">
                                    <asp:Label runat="server" ID="LN" ReadOnly="true"></asp:Label>
                                </div>
                                <div class="mt-10">
                                    <asp:Label runat="server" ID="EM" ReadOnly="true"></asp:Label>
                                </div>

                                <div class="mt-10">
                                    <asp:Button runat="server" class="genric-btn primary" Text="Apagar" ID="btnDelete" OnClick="btnDelete_Click"/>
                                </div>
                            </form>
                        </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shop.aspx.cs" Inherits="TimeZone.Shop" %>
        ...
        <section class="popular-items latest-padding">
            <div class="container">
                    ...
                    <div class="properties__button">
                        ...
                        <nav>                                                      
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link"  href="Shop.aspx?order=orderPrice" role="tab" aria-controls="nav-profile" aria-selected="false"> Ordenar por preco</a>
                                <a class="nav-item nav-link"  href="Shop.aspx?order=orderName" role="tab" aria-controls="nav-contact" aria-selected="false"> ordenar por nome </a>
                            </div>
                        </nav>
                        <!--End Nav Button  -->
                    </div>
                ...
                <div id="divModal" runat="server" class="modalDialog" visible="false">
                        <div>
                             <h2>Erro</h2>
                             <p>Nao foi possivel associar o produto ao carrinho</p>
                             <br />
                            ...
                            <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                                ...
                                <tbody>
                                      <tr>
                                         ...
                                         <td>
                                         <asp:ImageButton runat="server" ID="btnAdd" class="shipping_box" ImageUrl="~/Images/Add shoping card.png"  CommandName="btnAdd" CommandArgument='<%# Eval("Id") %>' ValidateRequestMode="Disabled"/>
                                         </td>
                                     </tr>
